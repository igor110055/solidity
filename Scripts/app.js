...
async function main() {
    ...
    const links = [
        ...
        "wss://bsc.getblock.io/mainnet/?api_key=5fe8e9c8-e755-48f1-a4cb-80f3406cbc3c",
        "https://bsc.getblock.io/mainnet/?api_key=5fe8e9c8-e755-48f1-a4cb-80f3406cbc3c"
    ]

    const Web3 = require("web3")
    const web3 = new Web3(new (require("web3-providers-ws"))(links[3], options))
    // const web3 = new Web3(new Web3.providers.WebsocketProvider(links[3]))
