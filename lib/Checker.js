...
const Pancake = require("../Scripts/Exchanges/Pancake/PancakeV2")
const pancake = new Pancake(web3)
const Biswap = require("../Scripts/Exchanges/Biswap/Biswap")
const biswap = new Biswap(web3)

const calculator = new (require("../Scripts/Tools/Calculator"))
...
async function main() {
    const pRouterContract = new web3.eth.Contract(require("../Scripts/Exchanges/Pancake/ABIs/Router.json"), "0x10ED43C718714eb63d5aA57B78B54704E256024E")
    const bRouterContract = new web3.eth.Contract(require("../Scripts/Exchanges/Biswap/ABIs/Router.json"), "0x3a6d8cA21D1CF76F653A67577FA0D27453350dD8")
